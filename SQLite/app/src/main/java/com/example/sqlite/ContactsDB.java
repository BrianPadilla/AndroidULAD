...
public class ContactsDB {
    ...
    public String getData(){
        ...
        int iNameRow = c.getColumnIndex(KEY_NAME);
        int iCellRow = c.getColumnIndex(KEY_CELL);

        for(c.moveToFirst();!c.isAfterLast();c.moveToNext()){
            result = result + c.getString(iRowID) + ": " + c.getString(iNameRow) + " "
                    + c.getString(iCellRow) + "\n";
        }
